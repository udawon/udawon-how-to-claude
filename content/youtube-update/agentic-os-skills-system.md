...
- MCP(외부 도구 연결 기능) 서버가 추가됐으면 그것도 인식

**세션 종료 시 (Wrap-up):**
- 오늘 만든 결과물 정리
- 피드백 수집 → learnings.md 업데이트
- 변경사항 Git(코드 버전 관리 도구) commit
...
graph TB
    ...
    style L4 fill:#c2410c,color:#fff,stroke:#c2410c,stroke-width:2px
    style L3 fill:#b45309,color:#fff,stroke:#b45309,stroke-width:2px
    style L2 fill:#1d4ed8,color:#fff,stroke:#1d4ed8,stroke-width:2px
    style L1 fill:#15803d,color:#fff,stroke:#15803d,stroke-width:2px
```
