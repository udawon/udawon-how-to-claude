...
order: 57
tags: ["보안", "법적", "기업·개발자", "Legal and compliance"]
---

# 법적 준수: Claude Code 사용 시 알아야 할 법률과 정책

Claude Code를 업무에 활용하는 것은 **외부 컨설턴트를 고용하는 것**과 비슷합니다. 컨설턴트에게 회사 자료를 보여줄 때 비밀유지계약(NDA)을 확인하듯, AI 도구를 쓸 때도 데이터 처리 방식과 이용 약관을 이해해야 합니다. 이 문서는 그 "계약서"를 쉽게 풀어 설명합니다.
